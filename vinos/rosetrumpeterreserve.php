...
<head>
    ...
    <title>Vino Trumpeter Reserve Rosé de Malbec</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Vino Trumpeter Reserve Rosé de Malbec</h2>
    <div class="producto">
        <div class="imagen">
            <img src="../images/vDiapositiva18.JPG" alt="Vino Trumpeter Reserve Rosé de Malbec">
        </div>
        <div>
            <p class="desc">

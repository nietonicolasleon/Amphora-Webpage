...
<head>
    ...
    <title>Vino San Felipe Cabernet Sauvignon Roble</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Vino San Felipe Cabernet Sauvignon Roble</h2>
    <div class="producto">
        <div class="imagen">
            <img src="../images/vDiapositiva17.JPG" alt="Vino SF Cabernet Sauvignon">
        </div>
        <div>
            <p class="desc">
                De color muy intenso con matices violáceos; de aroma muy frutado y especiado con toques de café y vainilla.
                En la boca es complejo, frutado, con taninos suaves y dulces. Aparecen notas de cacao que le da el tiempo de 7 meses en contacto con la madera.<br>
                <br>

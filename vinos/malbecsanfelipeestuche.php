...
<head>
    ...
    <title>Vino San Felipe Malbec Roble Estuche</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Vino San Felipe Malbec Roble Estuche</h2>
    <div class="producto">
        <div class="imagen">
            <img src="../images/vDiapositiva16.JPG" alt="Vino SF Malbec Estuche">
        </div>
        <div>
            <p class="desc">
                De color rojo rubí intenso. De aromas a frutas rojas, como frutillas o cerezas, con un leve toque a tabaco y café. En la boca es suave, redondo, con un retrogusto
                a chocolate que le da el tiempo de 7 meses en roble americano.<br>
                Contenido: 750 ml.<br>
                <br>
            </p>

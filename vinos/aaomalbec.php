...
<head>
    ...
    <title>Vino Aguijón de Abeja Obrera Malbec</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Vino Aguijón de Abeja Obrera Malbec</h2>
    <div class="producto">
        <div class="imagen">
            <img src="../images/vDiapositiva22.JPG" alt="Vino AAO Malbecc">
        </div>
        <div>
            <p class="desc">
                Al igual que la tarea laboriosa de la abeja, nuestra misión es explorar terruños más allá de Mendoza y recorrer distintas regiones vitivinícolas argentinas
                para encontrar el varietal que mejor nos representa en cada provicia. Así nace el vino federal, nuestro homenaje a la riqueza del suelo argentino.<br>
                <br>
                Contenido: 750 ml.<br>
                <br>
            </p>

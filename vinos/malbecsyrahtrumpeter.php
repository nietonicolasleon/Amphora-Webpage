...
<head>
    ...
    <title>Vino Trumpeter Malbec Syrah</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Vino Trumpeter Malbec Syrah</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                ...
                A la vista tiene un profundo color rubí oscuro con intensos tonos púrpuras.<br>
                La nariz es plena aparecen frutos rojos como grosellas y ciruelas maduras, con notas especiadas, que se entremezclan con el aroma a tabaco y chocolate.<br>
                De gran cuerpo y bien estructurado en boca, este vino tiene concentrados sabores frutos rojos y negros, con suaves y aterciopelados taninos.<br>
                Contenido: 750 ml.<br>
                <br>

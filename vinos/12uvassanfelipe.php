...
<head>
    ...
    <title>Vino San Felipe 12 Uvas</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Vino San Felipe 12 Uvas</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                Excepcional blend de 12 uvas provenientes de nuestros viñedos de Mendoza.<br>
                <br>
                A la vista se presenta rojo intenso, con reflejos rubí y matices granates. En nariz posee gran intensidad aromática, frutos rojos de cerezo y frutillas. aparecen también notas sutiles a tabaco y vainilla que 
                le dan su paso por roble. En la boca es muy frutado con taninos dulces, de buen cuerpo y larga persistencia.<br>
                <br>
                Contenido: 750 ml.<br>
                <br>

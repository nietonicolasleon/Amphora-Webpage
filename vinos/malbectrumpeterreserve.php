...
<head>
    ...
    <title>Vino Trumpeter Reserve Malbec</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Vino Trumpeter Reserve Malbec</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                ...
                Crianza en barricas: 12 meses &#40;30% roble francés nuevo y 70% de 2° uso&#41;<br>
                <br>
                Es un vino color rojo intenso con profundos matices violáceos. En nariz presenta una amplia gama aromática de frutos rojos como cerezas ciruelas,
                acompañados con notas de menta y vainilla que le da el tiempo en contacto con el roble. En la boca posee amables y armoniosos taninos los cuales 
                otorgan una textura sedosa y un largo final.<br>
                <br>

...
<head>
    ...
    <title>Combo Tres Mosqueteros</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Combo Tres Mosqueteros</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                El combo trae tres Espumantes San Felipe, uno Extra Brut, un Extra Dolce y un Rosé. ¡Que no falten en tu brindis!<br>

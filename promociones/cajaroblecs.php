...
<head>
    ...
    <title>Caja Roble Cabernet Sauvignon</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Caja Roble Cabernet Sauvignon</h2>
    <div class="producto">
        <div class="imagen">
            <img src="../images/Diapositiva17.JPG" alt="combo8">
        </div>
        <div>
            <p class="desc">
                La caja trae seis vinos San Felipe Roble Cabernet Sauvignon.<br>

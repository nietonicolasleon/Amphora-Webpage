...
<body>
    ...
    <h2 class="titular">Caja San Fe</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                La caja trae tres Vinos San Felipe Malbec Roble y tres Espumantes San Felipe Extra Brut, una caja de buena calidad y a un precio muy asequible.<br>

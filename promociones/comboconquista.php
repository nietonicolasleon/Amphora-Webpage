...
<body>
    ...
    <h2 class="titular">Combo Conquista</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                El combo trae un vino Trumpeter Malbec en Estuche, un vino Trumpeter Reserve Rosé de Malbec y un vino Trumpeter Reserve Doux. Los intensos sabores conquistarán tu paladar.<br>

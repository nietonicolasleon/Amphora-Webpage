...
<head>
    ...
    <title>Combo Familia Trumpeter 1</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Combo Familia Trumpeter 1</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                El combo trae un Vino Trumpeter Reserve Chardonnay, un Vino Trumpeter Reserve Pinot Noir y un Espumante Trumpeter Rosé de Malbec. Perfecto para disfrutar en familia.<br>

...
<head>
    ...
    <title>Combo Malbec y Amigos</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Combo Malbec y Amigos</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                El combo trae un vino Trumpeter Malbec en Estuche, un vino Trumpeter Malbec-Syrah y un vino Rutini Cabernet-Malbec. Recomendado para pasar tiempo con amigos que disfruten del Malbec tanto como vos.<br>

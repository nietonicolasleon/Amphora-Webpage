...
<head>
    ...
    <title>Caja Amantes de San Felipe</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Caja Amantes de San Felipe</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                La caja trae dos vinos San Felipe Roble Malbec, dos vinos San Felipe Roble Cabernet Sauvignon y dos vinos San Felipe Roble Merlot, solo para los amantes aférrimos de los vinos San Felipe.<br>

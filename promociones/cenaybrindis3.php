...
<head>
    ...
    <title>Combo Cena y Brindis Acto 3</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Combo Cena y Brindis Acto 3</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                El combo trae un Vino Rutini Malbec y un Espumante Encuentro Brut Nature Pinot Noir en Estuche, perfectos para acompañar con excelencia y elegancia una cena y brindar por los buenos momentos.<br>

...
<body>
    ...
    <h2 class="titular">Caja Malbec</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                La caja trae dos Vinos Rutini Malbec, dos Vinos Encuentro Malbec y dos Vinos Trumpeter Malbec, solo para los amantes aférrimos del malbec.<br>

...
<head>
    ...
    <title>Combo Familia Trumpeter 2</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <h2 class="titular">Combo Familia Trumpeter 2</h2>
    <div class="producto">
        <div class="imagen">
        ...
        <div>
            <p class="desc">
                El combo trae un Vino Trumpeter Malbec, un Vino Trumpeter Doux y un Espumante Trumpeter Extra Brut. Perfecto para disfrutar en familia.<br>

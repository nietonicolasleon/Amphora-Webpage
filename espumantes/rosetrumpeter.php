...
<head>
    ...
    <title>Espumante Trumpeter Rosé de Malbec</title>
</head>
<body>
    <div class="menu-btn">
    ...
    <div class="producto">
        <div class="imagen">
            <img src="../images/eDiapositiva3.JPG" alt="Espumante Trumpeter Rosé de Malbec">
        </div>
        <div>
            <p class="desc">
                Malbec 100% Uvas de nuestros viñedos cultivados al pie de la Cordillera de los Andes.<br>
                <br>
                Método Tradicional: 12 meses en contacto con sus borras.<br>
                <br>
                De color rosado salmón, con leves reflejos con un delicado aroma a cerezas y frutillas, combinando con el pan tostado que le aporta el contacto con las borras.
                De buen equilibrio, azúcar y acidez. Burbuja fina y persistente.<br>
                <br>
                Contenido: 750 ml.<br>
                <br>
